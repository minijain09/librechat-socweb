...
const { log } = require('utils/LoggingSystem');
...
class BaseClient {
  ...
  async saveMessageToDatabase(message, endpointOptions, user = null) {
    logger.debug('[BaseClient] Saving message to database:', {
      message,
      endpointOptions,
      user,
    });
    ...
    logger.debug('[BaseClient] Saved message:', savedMessage);
    logger.debug('skipSaveConvo:', this.skipSaveConvo);
    logger.debug('skipSaveUserMessage:', this.skipSaveUserMessage);
